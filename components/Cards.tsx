...
function Card(props: Props) {
  return (
    <div className="transform hover:scale-[1.01] transition-all rounded-xl w-full">
      <div className="p-1 rounded-lg bg-gradient-to-r from-[#afcafc] to-[#1fdcf5] max-w-4xl">
        <div className=" bg-white dark:bg-gray-900 rounded-lg p-3">
          ...
          <h1 className="font-bold text-xl my-3 ">Tech Stacks</h1>
          <div className="my-4">
            {/* {props.tech} */}
              ...
              return (
                ...
                >
                  <img
                    ...
                    className="h-6 w-6"
                  ></img>
                  <span className=" dark:text-gray-800">{skill}</span>
                </div>
              );
            })}
          </div>
